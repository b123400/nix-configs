...
in
{
  ...
  services.nginx.httpConfig=''
    ...
    #     include /etc/nginx/conf.d/ssl-wellknown.conf;
    #     ssl_certificate /etc/letsencrypt/live/but.ai/fullchain.pem;
    #     ssl_certificate_key /etc/letsencrypt/live/but.ai/privkey.pem;
